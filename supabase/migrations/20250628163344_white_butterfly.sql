/*
  ...
  3. Functions and Triggers
    - Keep existing `is_admin` function (used by other tables)
...
-- DO NOT drop is_admin function as it's used by other tables (agents, reports)
-- Instead, ensure it exists with the correct signature
