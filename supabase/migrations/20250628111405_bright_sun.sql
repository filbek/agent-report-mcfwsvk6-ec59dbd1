/*
  # Add Sample Agent and Report Data

  1. New Data
    - Insert Yurtdışı agents (Adviye, Cengiz, Dilara, Enedelya, Jennifer, Merve, Nadia, Nour)
    - Insert Yurtiçi agents (Cengiz Yurtiçi, Çiğdem, Hande, Hilal, Nazlı, Saliha, Yekta Check Up)
    - Insert Mayıs and Haziran reports for all agents
  
  2. Data Structure
    - All agents with proper categories
    - Performance reports matching Excel data
    - Calculated sales rates
*/
